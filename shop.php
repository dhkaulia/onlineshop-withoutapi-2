    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                <!-- Price Start -->
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Filter Harga</span></h5>
                <div class="bg-light p-4 mb-30">
                    <form>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" checked id="price-all">
                            <label class="custom-control-label" for="price-all">Semua Harga</label>
                            <span class="badge border font-weight-normal">52</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            ...
                            <label class="custom-control-label" for="price-2">Rp.100.000 - Rp.500.000</label>
                            <span class="badge border font-weight-normal">3</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="price-3">
                            <label class="custom-control-label" for="price-3">Rp.500.000 - Rp.1.000.000</label>
                            <span class="badge border font-weight-normal">10</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="price-4">
                            <label class="custom-control-label" for="price-4">Rp.1.000.000 - Rp.3.000.000</label>
                            <span class="badge border font-weight-normal">15</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between">
                            <input type="checkbox" class="custom-control-input" id="price-5">
                            <label class="custom-control-label" for="price-5">Rp.3.000.000 - Rp.5.000.000</label>
                            <span class="badge border font-weight-normal">19</span>
                        </div>
                    </form>
                </div>
                <!-- Price End -->
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <a class="h6 text-decoration-none text-truncate" href="">Celana Denim</a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>Rp.70.000</h5><h6 class="text-muted ml-2"><del>Rp.100.000</del></h6>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">Sweatshirt</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>Rp.150.000</h5><h6 class="text-muted ml-2"></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-primary mr-1"></small>
                                    <small class="fa fa-star text-primary mr-1"></small>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">Uniqlo Hoodie</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>Rp.300.000</h5><h6 class="text-muted ml-2"><del>Rp.399.000</del></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-primary mr-1"></small>
                                    <small class="fa fa-star text-primary mr-1"></small>
