        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    ?>
                        <tr>
                            <td class="align-middle"><img src="<?= $data['image'] ?>" alt="" style="width: 50px;"> <?= $data['name'] ?> </td>
                            ...
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    ...
                                    <input type="text" disabled class="form-control form-control-sm bg-secondary border-0 text-center" value="<?= $data['qty'] ?>">
                                    <!-- <div class="input-group-btn">
                            ...
                            <td class="align-middle"><?= number_format($totalbyproduct,0) ?></td>
                            <td class="align-middle"><button class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button></td>
                        </tr>
                        <?php } ?>
                        <!-- <tr>
                            <td class="align-middle"><img src="img/product-2.jpg" alt="" style="width: 50px;"> Sweatshirt</td>
